...
const SecondaryEducation = () => {
  ...
  const handleNext = () => {
    navigation.navigate('HigherSecondaryEducation'); 
  };

  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.heading}>Secondary Level</Text>

      <CustomDropdown
        label="Select Class *"
        options={['Matric', 'O Level']}
      ...
      <CustomDropdown
        label="Select Board *"
        options={selectedClass === 'Matric' ? pakBoards : oLevelBoards}
